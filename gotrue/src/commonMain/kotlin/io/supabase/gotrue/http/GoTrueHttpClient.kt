...
interface GoTrueHttpClient {
     ...
     */
    suspend fun post(path: String, headers: Map<String, String> = emptyMap(), data: Any? = null): String?
     ...
     * @return The response body as [String]
     */
    suspend fun put(path: String, headers: Map<String, String> = emptyMap(), data: Any): String
